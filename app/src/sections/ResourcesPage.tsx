...
const clients = [
  {
    ...
    name: 'Windows 客户端',
    // version: 'v2.0.1',
    downloadUrl: 'https://download.gsase.com/app/unimobile/windows/UniMobile.exe',  // 添加这行
    // size: '45 MB',
  },
  {
    icon: Apple,
    name: 'macOS 客户端',
    // version: 'v2.1.0',
    downloadUrl: 'https://apps.apple.com/app/id6753884805',  // 添加这行
    // size: '52 MB',
  },
  {
    icon: Smartphone,
    name: 'iOS 客户端',
    downloadUrl: 'https://apps.apple.com/app/id6753885045' , // 添加这行
    // version: 'v2.0.5',
    // size: '38 MB',
  },
  {
    icon: Monitor,
    name: 'Android 客户端',
    downloadUrl: 'https://download.gsase.com/app/unimobile/android/UniMobile.apk',  // 添加这行
    // version: 'v2.0.1',
    // size: '42 MB',
  },
];
