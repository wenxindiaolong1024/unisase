...
describe('Solutions Component', () => {
  ...
  it('should render section header by default', () => {
    ...
    expect(screen.getByText('UniSASE 方案')).toBeInTheDocument();
  ...
  it('should not render section header when isCompact is true', () => {
    ...
    expect(screen.queryByText('UniSASE 方案')).not.toBeInTheDocument();
  });
  ...
  it('should collapse solution details when clicked again', () => {
    ...
    const details = screen.queryByText('多种 IdP 支持');
  ...
  it('should render solution cards in grid layout', () => {
    ...
    const grid = container.querySelector('.md\\:cols-2');
  ...
  it('should not render architecture image in compact mode', () => {
    ...
    // Compact mode shouldn't have the architecture section
    const architectureSection = container.querySelector('.mb-8.bg-white');
    expect(architectureSection).not.toBeInTheDocument();
  });
});
