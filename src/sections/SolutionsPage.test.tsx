...
describe('SolutionsPage Component', () => {
  ...
  it('should switch active solution when button is clicked', () => {
    ...
    const networkButton = screen.getByText('组网');
  ...
  it('should render "Solutions 解决方案" badge', () => {
    render(<SolutionsPage />);

    expect(screen.getByText('Solutions 解决方案')).toBeInTheDocument();
  });

  it('should highlight active solution button', () => {
    render(<SolutionsPage />);

    const authButton = screen.getByText('认证');
  ...
  it('should update content when switching to control solution', () => {
    ...
    const controlButton = screen.getByText('管控');
  ...
  it('should update content when switching to isolation solution', () => {
    ...
    const isolationButton = screen.getByText('隔离');
  ...
  it('should update content when switching to analysis solution', () => {
    ...
    const analysisButton = screen.getByText('分析');
    fireEvent.click(analysisButton);

    expect(screen.getByText('基于 UniLog 统一日志与分析平台')).toBeInTheDocument();
  ...
  it('should handle all solution transitions correctly', () => {
    ...
    solutions.forEach((solution) => {
      const button = screen.getByText(solution);
      fireEvent.click(button);
      expect(button).toBeInTheDocument();
    });
  });

  it('should render UniPOP section', () => {
    render(<SolutionsPage />);
